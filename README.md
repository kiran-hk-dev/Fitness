...
- **Yoga images:** 12 sessions with auto-playing pose slideshows; **28/33 poses have distinct real animated photos** (each pose card auto-plays its own start⇄finish gallery + setup/breathing/easier/caution lines); only breath/cobra/downward-dog/warrior/boat use illustrated fallback (no free photos exist for those).
